    ...
    <div className="py-24">
      <div className="container">
        <div className="text-center mb-16">
          ...
          <p className="text-sm text-muted-foreground max-w-xl mx-auto">Salvaged vinyl records given 2nd life. Each reimagined as an original artwork, framed with the original vinyl record included.<br />A treat for walls & record players alike.</p>
        </div>
