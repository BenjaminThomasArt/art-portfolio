...
const upcycleArtworks = [
  {
    ...
    images: [
      ...
      "https://d2xsxph8kpxj0f.cloudfront.net/310519663325255079/TGNsMbsGdWXQhRmCtYbG6q/IMG_9226_color_corrected_292ff2b5.jpeg",
    ],
  },
  {
    id: 4,
    ...
    <div className="py-24">
      <div className="container">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-serif tracking-tight text-[#003153] mb-4">Artifacts</h1>
