    ...
    <div className="py-24">
      <div className="container">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto">Salvaged vinyl records given new life. Each cover is reimagined as an original artwork, framed and available with the vinyl included.</p>
        </div>
