    ...
    <div className="py-24">
      <div className="container">
        <div className="text-center mb-16">
          ...
          <p className="text-sm text-muted-foreground max-w-xl mx-auto">Salvaged vinyl records given new life.<br />Each cover is reimagined as an original artwork, framed and available with the original vinyl record included.<br />A treat for walls and record players alike.</p>
        </div>
