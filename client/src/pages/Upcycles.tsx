    ...
    <div className="py-24">
      <div className="container">
        <div className="text-center mb-16">
          ...
          <p className="text-sm text-muted-foreground max-w-xl mx-auto">Salvaged vinyl 12" records given new life; each reimagined as an original artwork, framed with the original vinyl record included.<br />A treat for walls & record players alike.</p>
        </div>
