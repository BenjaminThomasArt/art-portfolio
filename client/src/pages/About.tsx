            ...
            <div className={artistInfo?.profileImageUrl ? "md:col-span-2" : "md:col-span-3"}>
              <div className="prose prose-lg max-w-none">
                <p className="text-foreground leading-relaxed whitespace-pre-line">
                  {artistInfo?.bio ||
                    "Benjamin Thomas is a contemporary abstract artist based in London. His practice is an ongoing exploration of form and material, where each artwork marks a point in a connected and evolving body of work.\n\nThomas approaches painting as a means of exploring creative energies and intuition. Forms, gestures and surfaces carry from one piece to the next, reappearing through layering, reproduction and shifts in process. Earlier works often inform later ones, creating connections across different materials and formats.\n\nEach painting stands independently, yet also contributes to a broader aesthetic \u2014 a thread that runs through the practice as textures and finish evolve.\n\nHis Upcycled series extends this approach to found objects: vinyl records are thrifted across East London; paint and sound coexist within a single frame."}
                </p>
              </div>
            </div>
          </div>
