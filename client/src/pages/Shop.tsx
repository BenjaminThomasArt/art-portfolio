      ...
      <div className="relative h-[60vh] min-h-[500px] overflow-hidden">
        ...
        <div className="relative h-full flex items-center justify-center">
          <div className="text-center px-8 md:px-16 lg:px-24">
            ...
            <p className="text-sm md:text-base text-muted-foreground max-w-3xl mx-auto">Quality prints available to order in a range of materials and sizes.<br />Custom orders available on request.</p>
          </div>
        </div>
      </div>
