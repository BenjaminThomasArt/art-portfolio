      ...
      <div className="relative h-[60vh] min-h-[500px] overflow-hidden">
        ...
        <div className="relative h-full flex items-center justify-center">
          <div className="text-center px-8 md:px-16 lg:px-24">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif tracking-tight mb-4 text-[#003153]">Prints</h1>
            <p className="text-sm text-muted-foreground max-w-3xl mx-auto">Quality prints available to order in a range of materials and sizes. Custom orders available on request.</p>
          </div>
        </div>
      </div>
